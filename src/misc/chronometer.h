...
{
public:
    static const size_t EVENT_COUNTER = EventUtil<ID - 1>::EVENT_COUNTER;
    ...
    static const size_t NUM_EVENTS = EventUtil<ID - 1>::EVENT_COUNTER;
...
#define DEFINE_EVENT(CLASS_NAME, PARENT, EVENT_NAME, EVENT_ID)      \
    ...
    {                                                               \
    public:                                                         \
        static const size_t EVENT_COUNTER = EVENT_ID + 1;           \
                                                                    \
        std::string operator()()                                    \
        {                                                           \
            return EVENT_NAME;                                      \
...
public:
    ...
    std::string report()
    {
        ...
        for (size_t i = 0; i < NUM_INTERVALS; ++i) {
            buf << std::left << std::setw(20) << ChronometerHelpers::EventToString()(i) << ": " << totalTimes[i] << "s\n";
        }
