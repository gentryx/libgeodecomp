...
extern MPI_Datatype MPI_LIBGEODECOMP_STATISTICS;
...
private:
    ...
    static MPI_Datatype generateMapLibGeoDecomp_Statistics();
    ...
    static inline MPI_Datatype lookup(int*) { return MPI_INT; }
    static inline MPI_Datatype lookup(long*) { return MPI_LONG; }
    static inline MPI_Datatype lookup(long double*) { return MPI_LONG_DOUBLE; }
    ...
    static inline MPI_Datatype lookup(LibGeoDecomp::CoordBox<1 >*) { return MPI_LIBGEODECOMP_COORDBOX_1_; }
    ...
    static inline MPI_Datatype lookup(LibGeoDecomp::Statistics*) { return MPI_LIBGEODECOMP_STATISTICS; }
    ...
    static inline MPI_Datatype lookup(LibGeoDecomp::StreakMPIDatatypeHelper*) { return MPI_LIBGEODECOMP_STREAKMPIDATATYPEHELPER; }
    static inline MPI_Datatype lookup(LibGeoDecomp::TestCell<1 >*) { return MPI_LIBGEODECOMP_TESTCELL_1_; }
