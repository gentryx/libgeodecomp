...
public:
    ...
    public:
        ...
        virtual bool operator()(const StringOps::StringVec& parameters, Pipe& pipe, GridType *grid, const Region<Topology::DIM>& validRegion)
        {
    ...
    void testBasic()
    {
        ...
        bool res = handler(parameters, pipe, &grid, region);
