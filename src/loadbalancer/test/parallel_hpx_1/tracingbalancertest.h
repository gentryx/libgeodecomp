...
public:
    ...
    {
        std::ostringstream voidStream;
        boost::shared_ptr<LoadBalancer> balancer1(new TracingBalancer(new HPXSerializationTest::TestBalancer(4711)));
        boost::shared_ptr<LoadBalancer> balancer2(new TracingBalancer(0, voidStream));
