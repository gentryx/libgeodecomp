...
public:
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::CoordBox<1 >& object, const unsigned /*version*/)
    {
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::CoordBox<2 >& object, const unsigned /*version*/)
    {
        archive & object.dimensions;
        archive & object.origin;
    }
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::CoordBox<3 >& object, const unsigned /*version*/)
    {
        archive & object.dimensions;
        archive & object.origin;
    }
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::CoordBoxMPIDatatypeHelper& object, const unsigned /*version*/)
    {
        archive & object.a;
        archive & object.b;
        archive & object.c;
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::FixedArray<double,Chronometer::NUM_INTERVALS >& object, const unsigned /*version*/)
    {
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordBase<1 >& object, const unsigned /*version*/)
    {
        archive & object.c;
    }
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordBase<2 >& object, const unsigned /*version*/)
    {
        archive & object.c;
    }
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordBase<3 >& object, const unsigned /*version*/)
    {
        archive & object.c;
    }
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordBaseMPIDatatypeHelper& object, const unsigned /*version*/)
    {
        archive & object.a;
        archive & object.b;
        archive & object.c;
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::MySimpleCell& object, const unsigned /*version*/)
    {
        archive & object.temp;
    }
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::Streak<1 >& object, const unsigned /*version*/)
    {
        archive & object.endX;
        archive & object.origin;
    }
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::Streak<2 >& object, const unsigned /*version*/)
    {
        archive & object.endX;
        archive & object.origin;
    }
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::Streak<3 >& object, const unsigned /*version*/)
    {
        archive & object.endX;
        archive & object.origin;
    }
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::StreakMPIDatatypeHelper& object, const unsigned /*version*/)
    {
        archive & object.a;
        archive & object.b;
        archive & object.c;
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::TestCell<1 >& object, const unsigned /*version*/)
    {
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::TestCell<2 >& object, const unsigned /*version*/)
    {
        archive & object.cycleCounter;
        archive & object.dimensions;
        archive & object.isEdgeCell;
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::TestCell<3 >& object, const unsigned /*version*/)
    {
        archive & object.cycleCounter;
        archive & object.dimensions;
        archive & object.isEdgeCell;
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::TestCellMPIDatatypeHelper& object, const unsigned /*version*/)
    {
        archive & object.a;
        archive & object.b;
        archive & object.c;
    ...
    template<typename ARCHIVE>
    inline
    static void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordMPIDatatypeHelper& object, const unsigned /*version*/)
    {
        archive & object.a;
        archive & object.b;
        archive & object.c;
...
template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::CoordBox<1 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::CoordBox<2 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::CoordBox<3 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::CoordBoxMPIDatatypeHelper& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::FixedArray<double,Chronometer::NUM_INTERVALS >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordBase<1 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordBase<2 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordBase<3 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordBaseMPIDatatypeHelper& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::MySimpleCell& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::Streak<1 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::Streak<2 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::Streak<3 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::StreakMPIDatatypeHelper& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::TestCell<1 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::TestCell<2 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::TestCell<3 >& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}

template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::TestCellMPIDatatypeHelper& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}
...
template<class ARCHIVE>
void serialize(ARCHIVE& archive, LibGeoDecomp::FloatCoordMPIDatatypeHelper& object, const unsigned version)
{
    Typemaps::serialize(archive, object, version);
}
